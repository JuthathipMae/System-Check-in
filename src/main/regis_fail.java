 ...
 * @author maerj
 */
public class regis_fail extends javax.swing.JFrame {

    /**
     * Creates new form regis_fail
     */
    public regis_fail() {
        initComponents();
    }
...
this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(regis_fail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new regis_fail().setVisible(true);
            }
        });
    }
