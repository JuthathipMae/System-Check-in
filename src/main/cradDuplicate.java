 ...
 * @author maerj
 */
public class cradDuplicate extends javax.swing.JFrame {

    /**
     * Creates new form cradDuplicate
     */
    public cradDuplicate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label.setFont(new java.awt.Font("Segoe UI", 0, 17)); // NOI18N
        label.setForeground(new java.awt.Color(102, 102, 102));
        label.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label.setText("Duplicate data: Student_ID or CardID already exists");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cradDuplicate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
